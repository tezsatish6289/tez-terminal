      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-20">
        ...
        >
          <p className="text-lg" style={{ color: "#94a3b8" }}>
            Our Privacy Policy is being drafted and will be published here soon.
            We are committed to protecting your data and being fully transparent
            about how we use it. Please check back shortly.
          </p>
        </div>
      </div>
    </div>
