              ...
              <div className="px-4 py-2 border-b border-white/[0.06] bg-white/[0.02]">
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-16 sm:w-24 flex items-center gap-0.5 h-1.5 shrink-0">
                    ...
                    />
                    <div
                      className="h-full bg-negative/50 rounded-r-full transition-all duration-700"
                      style={{ width: `${bullAggScore + bearAggScore > 0 ? (bearAggScore / (bullAggScore + bearAggScore)) * 100 : 50}%` }}
                    />
                  </div>
                    ...
                    <OpportunityCard
                      ...
                      score={signal.confidenceScore != null ? {
                        ...
                        color: signal.confidenceScore >= 80 ? "text-positive"
                          ...
                          : "text-orange-400",
                        breakdown: { priceStructure: 0, pattern: "none" as const, rrGateFailed: false },
                      } : undefined}
                    />
                  ))}
                </div>
