...
import { User, LogOut, Zap, History, LineChart, Webhook, Settings, CreditCard, Bell, Gift, Users, Twitter, Activity, Link2, ClipboardList, MessageSquare, Bot, ListChecks, BarChart3, ShieldCheck, Target, Gauge, Map, Clapperboard, Video, Newspaper } from "lucide-react";
...
export function TopBar() {
  ...
  const adminItems = [
    ...
    { name: "SR Zone Audit", icon: Target, href: "/admin/sr-audit" },
    { name: "Level Cron", icon: Gauge, href: "/admin/levels-cron" },
