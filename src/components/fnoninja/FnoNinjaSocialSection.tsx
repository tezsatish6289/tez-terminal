    ...
    >
      <div className={`${FB_NARROW_SHELL} text-center`}>
        ...
        <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
          Stay connected with FNO NINJA
        </h2>
        <p className="mt-3 max-w-md mx-auto text-sm sm:text-base leading-relaxed" style={{ color: FNO_MUTED }}>
          ...
          {FNONINJA_SOCIAL_LINKS.map((link) => (
            <li key={link.platform}>
              <a
                ...
                className="group flex h-12 w-12 items-center justify-center rounded-xl transition-all hover:scale-105"
                style={{
                  color: "#94a3b8",
