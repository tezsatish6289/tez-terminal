...
export function SimulatorToolbar({
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-transparent p-3 sm:p-4 space-y-3">
      <div className="flex flex-col lg:flex-row lg:items-center gap-3 lg:gap-4">
        {/* Asset switch */}
        <div className="flex items-center gap-1 rounded-xl border border-white/[0.08] bg-black/30 p-1 w-fit shrink-0">
        ...
        <div className="flex items-center gap-1.5 shrink-0 flex-wrap sm:flex-nowrap">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.03] px-2.5 py-2 text-[10px] font-bold uppercase tracking-wider text-muted-foreground hover:text-foreground hover:bg-white/[0.06] transition-colors"
          >
          ...
          <Link
            href="/stats"
            className="flex items-center gap-1.5 rounded-lg border border-accent/25 bg-accent/[0.08] px-2.5 py-2 text-[10px] font-bold uppercase tracking-wider text-accent hover:bg-accent/[0.14] transition-colors"
          >
...
function StatChip({
  ...
  return (
    <div
      className={cn(
        "rounded-lg border px-3 py-2 min-w-[88px]",
        accent
