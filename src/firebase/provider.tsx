...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  }, [firebaseApp, firestore, database, auth, userAuthState]);
...
export const useFirebase = (): FirebaseServicesAndUser => {
  ...
  if (!context.areServicesAvailable || !context.firebaseApp || !context.firestore || !context.database || !context.auth) {
...
/** Hook to access Realtime Database instance (community chat live stream + presence). */
